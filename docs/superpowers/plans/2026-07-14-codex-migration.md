...
- [ ] **Step 1: Run a backward-compatibility review scenario without the migrated skill**
...
- [ ] **Step 2: Run an idempotency review scenario without the migrated skill**
...
- [ ] **Step 3: Preserve the observed gaps as forward-test assertions**
...
- [ ] **Step 2: Create `AGENTS.md` and remove `CLAUDE.md`**
...
- [ ] **Step 2: Create the skill and knowledge reference**
...
- [ ] **Step 4: Create the read-only custom agent**
...
- [ ] **Step 2: Create the skill and references**
...
- [ ] **Step 3: Create UI metadata and the read-only custom agent**
...
- [ ] **Step 1: Write failing synthetic hook checks**
...
- [ ] **Step 2: Implement patch-path extraction and credential denial**
...
- [ ] **Step 3: Implement shell linting**
...
- [ ] **Step 4: Register hooks and Context7**
...
- [ ] **Step 5: Verify scripts and payload behavior**
...
- [ ] **Step 4: Run all native validation**
